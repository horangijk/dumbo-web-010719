...
// 1. When the page renders, the user should see all of the data for a given location
// 2. When the user types into the search box, it should filter the list of locations
// by name
